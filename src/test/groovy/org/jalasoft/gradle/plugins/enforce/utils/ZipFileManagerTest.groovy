...
class ZipFileManagerTest extends Specification {
    ...
    def setup() {
        ...
        String inputDirectory = System.getProperty("user.dir") + "/src/test/groovy/org/jalasoft/gradle/plugins/enforce/utils/resources/classes/"
        String targetPath = System.getProperty("user.dir") + "/src/test/groovy/org/jalasoft/gradle/plugins/enforce/utils/resources/"
