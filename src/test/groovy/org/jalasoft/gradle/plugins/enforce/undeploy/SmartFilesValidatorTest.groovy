...
package org.jalasoft.gradle.plugins.enforce.undeploy
...
class SmartFilesValidatorTest extends Specification {
    ...
    @Shared
    def SRC_PATH = System.getProperty("user.dir") + "/src/test/groovy/org/jalasoft/gradle/plugins/enforce/undeploy/resources"
