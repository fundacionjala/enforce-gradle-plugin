...
class ClassInterceptorTest extends Specification {
    ...
    @Shared
    String RESOURCE_PATH = "${ROOT_PATH}/src/test/groovy/org/jalasoft/gradle/plugins/enforce/interceptor/resources/classes"
    @Shared
    ...
    def "Should execute the commands of class truncator"() {
        ...
        int totalSize = 0
        classInterceptor.interceptorsToExecute = [org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_CLASSES.id]
        int total = 0
