...
package org.jalasoft.gradle.plugins.enforce.tasks.salesforce.retrieve

import org.jalasoft.gradle.plugins.enforce.credentialmanagement.CredentialManager
import org.jalasoft.gradle.plugins.enforce.undeploy.PackageComponent
...
class RetrieveTest extends spock.lang.Specification {
    ...
    @Shared
    def path = Paths.get(System.getProperty("user.dir"), "src", "test", "groovy", "org", "jalasoft", "gradle",
