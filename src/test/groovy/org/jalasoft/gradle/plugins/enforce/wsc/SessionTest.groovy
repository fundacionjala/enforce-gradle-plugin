...
class SessionTest extends Specification {
    ...
    def setupSpec() {
        ...
        GetUserInfoResult userInfoResult = new GetUserInfoResult(userId: '1234567', userFullName: 'Juan Perez', userEmail: 'jperez@jalasoft.com')
    ...
    def 'gets session info'() {
        ...
        session.userEmail == 'jperez@jalasoft.com'
    }
}
