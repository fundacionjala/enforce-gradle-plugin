...
class OrgValidatorTest extends Specification {
    ...
    def setup() {
        ...
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','Class2.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','TemporalClass.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','TemporalClass.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','Lunes.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','Lunes.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','LunesTest.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','LunesTest.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','MyClass1.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','MyClass1.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','MyStringStack.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','MyStringStack.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','StringStack.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','StringStack.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','TestClass.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','TestClass.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','TestClass1.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','TestClass1.cls-meta.xml').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','myFavoriteClass.cls').toString()))
        validClassFiles.add(new File(Paths.get(SRC_PATH,'classes','myFavoriteClass.cls-meta.xml').toString()))

        invalidClassFiles.add(new File(Paths.get(SRC_PATH,'classes','fallClass1.cls').toString()))
        invalidClassFiles.add(new File(Paths.get(SRC_PATH,'classes','fallClass1.cls-meta.xml').toString()))
        invalidClassFiles.add(new File(Paths.get(SRC_PATH,'classes','fallClass2.cls').toString()))
        invalidClassFiles.add(new File(Paths.get(SRC_PATH,'classes','fallClass2.cls-meta.xml').toString()))
        invalidClassFiles.add(new File(Paths.get(SRC_PATH,'classes','fallClass3.cls').toString()))
        invalidClassFiles.add(new File(Paths.get(SRC_PATH,'classes','fallClass3.cls-meta.xml').toString()))

        validTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','trigger2.trigger').toString()))
        validTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','trigger2.trigger-meta.xml').toString()))
        validTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','LunesTrigger.trigger').toString()))
        validTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','LunesTrigger.trigger-meta.xml').toString()))

        invalidTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','triggerFall1.trigger').toString()))
        invalidTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','triggerFall1.trigger-meta.xml').toString()))
        invalidTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','triggerFall2.trigger').toString()))
        invalidTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','triggerFall2.trigger-meta.xml').toString()))
        invalidTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','triggerFall3.trigger').toString()))
        invalidTriggerFiles.add(new File(Paths.get(SRC_PATH,'triggers','triggerFall3.trigger-meta.xml').toString()))
        ...
        mapExpected.put(Constants.FILE_WHITOUT_VALIDATOR, new ArrayList<File>())
    }
