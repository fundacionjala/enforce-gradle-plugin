...
class UpdateTest extends Specification {
    ...
    def "Test should asdfade" () {
        ...
        trackerMap.put('classes/Class2.cls',new ResultTracker(ComponentStates.CHANGED))
        trackerMap.put('classes/Class3.cls',new ResultTracker(ComponentStates.CHANGED))
        ...
        /*    trackerMap.put('triggers/Trigger1.trigger',new ResultTracker(ComponentStates.ADDED))
            trackerMap.put('triggers/Trigger2.trigger',new ResultTracker(ComponentStates.ADDED))
            trackerMap.put('triggers/Trigger3.trigger',new ResultTracker(ComponentStates.CHANGED))
            ...
            trackerMap.put('objects/Object1__c.object',new ResultTracker(ComponentStates.ADDED))
            trackerMap.put('objects/Object2__c.object',new ResultTracker(ComponentStates.ADDED))
            trackerMap.put('objects/Object3__c.object',new ResultTracker(ComponentStates.ADDED))*/
        ...
        updateInstance.filterFiles()
        //  println "***************************************"
        //  println updateInstance.filesExcludes
        then:
        true
    }
