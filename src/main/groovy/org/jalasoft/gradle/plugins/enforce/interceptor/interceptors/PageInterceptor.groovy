...
import org.jalasoft.gradle.plugins.enforce.interceptor.commands.Page
...
class PageInterceptor extends MetadataInterceptor {
    ...
    void loadInterceptors() {
        addInterceptor(org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_PAGES.id, new Page().execute)
    }
}
