...
import org.jalasoft.gradle.plugins.enforce.interceptor.commands.Component
...
class ComponentInterceptor extends MetadataInterceptor {
    ...
    void loadInterceptors() {
        addInterceptor(org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_COMPONENTS.id, new Component().execute)
    }
}
