...
import org.jalasoft.gradle.plugins.enforce.utils.AnsiColor
...
class Deploy extends Deployment {
    ...
    def truncateComponents() {
        ...
        interceptorsToExecute = [org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_CLASSES.id, org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_FIELD_SETS.id, org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_ACTION_OVERRIDES.id,
                                org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_FORMULAS.id, org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_WEB_LINKS.id, org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_PAGES.id,
                                org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_TRIGGERS.id, org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_WORKFLOWS.id,
                                org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_COMPONENTS.id]
        interceptorsToExecute += interceptors
