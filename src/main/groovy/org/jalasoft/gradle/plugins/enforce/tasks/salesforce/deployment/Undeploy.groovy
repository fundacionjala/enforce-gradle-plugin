...
import org.jalasoft.gradle.plugins.enforce.interceptor.InterceptorManager
...
import org.jalasoft.gradle.plugins.enforce.utils.salesforce.MetadataComponent
...
class Undeploy extends Deployment {
    ...
    Undeploy() {
        ...
        interceptorsToExecute = org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.INTERCEPTORS.values().toList()
