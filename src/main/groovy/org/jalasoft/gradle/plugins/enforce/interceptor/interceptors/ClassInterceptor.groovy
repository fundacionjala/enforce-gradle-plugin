...
import org.jalasoft.gradle.plugins.enforce.interceptor.commands.ClassAnnotation
import org.jalasoft.gradle.plugins.enforce.interceptor.commands.Class
...
class ClassInterceptor extends MetadataInterceptor {
    ...
    void loadInterceptors() {
        ...
        addInterceptor(org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.REMOVE_DEPRECATE.id, annotationCmd.execute)
        Class contentCmd = new Class()
        addInterceptor(org.jalasoft.gradle.plugins.enforce.interceptor.Interceptor.TRUNCATE_CLASSES.id, contentCmd.execute)
    }
}
