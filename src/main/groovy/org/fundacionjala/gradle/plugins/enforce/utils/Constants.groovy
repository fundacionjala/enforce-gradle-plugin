...
public class Constants {
    ...
    public static final String FILE_WITHOUT_METADATA = "File without metadata"
    public static final String FILE_WITHOUT_VALIDATOR = "File without validator"

    public static final String FILES_NOT_FOUND = "Files not found:"
    public static final String FOLDERS_NOT_FOUND = "Folders not found:"
